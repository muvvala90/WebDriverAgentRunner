...
import Accessibility
 ...
 class SofleteDemoTests: XCTestCase {
...
//   let app = XCUIApplication(bundleIdentifier: "com.sidebench.soflete.staging")
    ...
    override func tearDownWithError() throws {
     ...
     func testLogin() throws {
         ...
         // Verify that Logo, Text elements are presented
       ...
       //  try testloginThroughGmail(environment: "development")
         ...
         print("Total Buttons are appeared in this screen:",btnCount)
...
//        try testLogout()
     ...
     func PreviousGmailLinkDelete_SFLTappLaunch(environment:String) throws {
         ...
         if environment=="development" {
             ...
             editSearchbar.tap()
             sleep(5)
             editSearchbar.typeText("Sign in to ")
             editSearchbar.typeText("Soflete Development")
             sleep(2)
             app.buttons["Search"].tap()
             sleep(2)
             
             let noReplyLabel=app.staticTexts.containing(.staticText, identifier: "Sign in to Soflete Development").element(boundBy: 1)
